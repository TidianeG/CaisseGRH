                                            ...
                                            <div class="card-header">
                                                ...
                                                <div class="d-flex justify-content-between">
                                                    <div class="col-auto " style="display: flex; flex-direction: column; justify-content: center;">
                                                        <h5 class="container-fluid"> <i class="fa-solid fa-list"></i> Liste des Fonctions</h5>
                                                    </div>
                                                    <div>
                                                        <button type="button" data-toggle="modal" data-target="#add_new_site" class="btn btn-primary">
                                                            <i class="fa-solid fa-home"></i> Nouvelle Fonction
                                                        </button>
                                                    </div>
                                    ...
                                    <div class="row">
                                        <div class="col-xl">
                                            <div class="card mb-4">
                                                ...
                                                <h5 class="mb-0">Nouvelle Fonction</h5>
                                                    ...
                                                    <form method="POST" action="{{route('configuration.add_fonction')}}">
                                                        ...
                                                        <div class="mb-3">
                                                            <label class="form-label" for="basic-icon-default-fullname">Nom Fonction</label>
                                                                <div class="input-group input-group-merge">
                                                                    <input type="text" name="nom_fonction" class="form-control" id="nom_fonction" placeholder="Nom Fonction" required  aria-describedby="basic-icon-default-fullname2" />
                                                                </div>
                                                        </div>
                                                        ...
                                                        <div class="mb-3">
                                                            <label class="form-label" for="basic-icon-default-fullname">Description</label>
                                                                <div class="input-group input-group-merge">
                                                                    <textarea name="description_fonction" id="description_fonction" class="form-control" cols="30" rows="5"></textarea>
