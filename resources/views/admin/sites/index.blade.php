    @extends('layouts.appadmin')
        @section('content')
                                            ...
                                            <div class="card-header">
                                                <div class="d-flex justify-content-between">
                                                    <div class="col-auto " style="display: flex; flex-direction: column; justify-content: center;">
                                                        <h5 class="container-fluid"> <i class="fa-solid fa-list"></i> Liste des Sites</h5>
                                                    </div>
                                                    <div>
                                                        <button type="button" data-toggle="modal" data-target="#add_new_site" class="btn btn-primary">
                                                        <i class="fa-solid fa-house-medical"></i> Nouveau Site
                                                        </button>
                                                        <button type="button" data-toggle="modal" data-target="#add_new_site_lot" class="btn btn-primary">
                                                        ...
                                                        <div class="mb-3">
                                                            <label class="form-label" for="basic-icon-default-fullname">Nom Site</label>
                                                                <div class="input-group input-group-merge">
                                                                    <input type="text" name="nom_site" class="form-control" id="nom_site" placeholder="Nom Site" required  aria-describedby="basic-icon-default-fullname2" />
                                                                </div>
                                                        </div>
                                                        <div class="mb-3">
                                                            <label class="form-label" for="basic-icon-default-fullname">Description</label>
                                                                <div class="input-group input-group-merge">
                                                                    <textarea name="description_site" id="description_site" class="form-control" cols="30" rows="5"></textarea>
                ...
                <div class="modal fade" id="add_new_site_lot" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
                        <div class="modal-dialog modal-dialog-centered">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <nav class="navbar navbar-light ">
